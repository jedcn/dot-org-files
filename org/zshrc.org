...
** Basic Setup
   ...
   And I am currently trying out the git plugin:
...
*** RVM
    ...
    I sometimes use RVM to manage my Rubies. At the end of the RVM
    install, we're told to setup our ZSH with the following (it does no
    harm if rvm isn't present):
